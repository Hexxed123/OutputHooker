...
int TestOutputWindow::lastSelectedCategory = 0;
    ...
    , ui(new Ui::TestOutputWindow)
{
    ...
    connect(ui->cbCategory, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TestOutputWindow::handleCategoryChanged);
...
FunctionCommand TestOutputWindow::getCommand() const
{
    ...
    case CmdBlamconIGF:
        ...
        if (ui->cbParameter2->currentText() == "LED")
        {
            cmd.param2 += "." + ui->lineEditParameter4->text();

            if (ui->cbParameter5->currentText() == "1x" || ui->cbParameter5->currentText() == "2x")
            {
                cmd.param2 += "." + ui->cbParameter5->currentData().toString();
            }
        }
        break;
    ...
    case CmdFusionIGF:
        cmd.commandCode = COMPORTWRITE;
        cmd.param1 = ui->cbParameter1->currentText();
        cmd.param2 = ui->cbParameter2->currentData().toString() + "x" + ui->cbParameter3->currentData().toString();

        if (!ui->lineEditParameter4->text().isEmpty())
        {
            cmd.param2 += "x" + ui->lineEditParameter4->text();
        }
        break;
    ...
    case CmdOpenFirePO:
        cmd.commandCode = COMPORTWRITE;
        cmd.param1 = ui->cbParameter1->currentText();
        cmd.param2 = ui->cbParameter2->currentData().toString() + "x" + ui->cbParameter3->currentData().toString() + "x" + ui->lineEditParameter4->text();
        break;
...
bool TestOutputWindow::eventFilter(QObject *obj, QEvent *event)
{
...
// Handle category ComboBox
void TestOutputWindow::handleCategoryChanged(int index)
{
    if (index < 0)
        return;
...
void TestOutputWindow::setupBlamconUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
...
void TestOutputWindow::setupFusionUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupOpenFireUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupRsMX24UI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupRsReaperUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupSindenUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, true, false, false);
    setParamComboBoxVisibility(true, true, true, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupXgunnerUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupAlienUI(CommandType cmd)
{
    setParamLabelVisibility(true, false, false, false, false);
    setParamComboBoxVisibility(true, false, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupSDL3UI(CommandType cmd)
{
    setParamLabelVisibility(true, true, false, false, false);
    setParamComboBoxVisibility(true, true, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupUsbHidUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, true, true, true);
    setParamComboBoxVisibility(true, false, false, false, false);
...
void TestOutputWindow::setupTcpUI(CommandType cmd)
{
    setParamLabelVisibility(true, false, false, false, false);
    setParamComboBoxVisibility(true, false, false, false, false);
    setParamLineEditVisibility(false, false, false, false, false);
...
void TestOutputWindow::setupUdpUI(CommandType cmd)
{
    setParamLabelVisibility(true, true, true, true, false);
    setParamComboBoxVisibility(true, false, false, false, false);
...
bool TestOutputWindow::validateStrengthPulseValue(const FunctionCommand &cmd)
{
    const QString errorStyle = "border: 1px solid red;";
...
bool TestOutputWindow::validateLedFadeTimeValue(const FunctionCommand &cmd)
{
    const QString errorStyle = "border: 1px solid red;";
...
bool TestOutputWindow::validateRumbleValues(const FunctionCommand &cmd)
{
    const QString errorStyle = "border: 1px solid red;";
...
bool TestOutputWindow::validateTcpUdpPort(const FunctionCommand &cmd)
{
    const QString errorStyle = "border: 1px solid red;";
...
void TestOutputWindow::resetInputs()
{
    ...
    connect(ui->lineEditParameter4, &QLineEdit::textChanged, this, &TestOutputWindow::clearErrorStyle);
    connect(ui->lineEditParameter4, &QLineEdit::textChanged, this, &TestOutputWindow::updateCommandDisplay);
